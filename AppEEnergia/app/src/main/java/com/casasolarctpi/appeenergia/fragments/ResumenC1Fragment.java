...
public class ResumenC1Fragment extends Fragment {

    private View view;
    private RecyclerView recyclerView;
    private DataSummary dataSummary = new DataSummary();

    public ResumenC1Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_resumen_c1, container, false);
        inizialite();
    ...
    private void inizialite() {
        recyclerView = view.findViewById(R.id.recyclerViewC1);
        dataSummary = IndexFragment.dataSummaryC1;
    }
