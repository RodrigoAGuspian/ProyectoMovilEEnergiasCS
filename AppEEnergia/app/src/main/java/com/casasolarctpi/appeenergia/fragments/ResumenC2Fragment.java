...
public class ResumenC2Fragment extends Fragment {

    private View view;
    private RecyclerView recyclerView;
    private DataSummary dataSummary = new DataSummary();

    public ResumenC2Fragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_resumen_c2, container, false);
        inizialite();
    ...
    private void inizialite() {
        recyclerView = view.findViewById(R.id.recyclerViewC2);
        dataSummary = IndexFragment.dataSummaryC2;
    }
